...
public class MapMarkerDot extends MapMarkerCircle {
    ...
    public MapMarkerDot(Layer layer, String name, double lat, double lon,Style getStyle) {
    	this(layer, name, new Coordinate(lat, lon), getStyle);
    }
